...
final_books = [
    # Science & Technology (1 book)
    {"id": 29393, "title": "Introduction to Science", "author": "J. Arthur Thomson", "genres": ["Science & Technology", "Non-Fiction"]},
    
    # Social Sciences (2 books)
    {"id": 147, "title": "Common Sense", "author": "Thomas Paine", "genres": ["Social Sciences", "History", "Non-Fiction"]},
    {"id": 1184, "title": "The Subjection of Women", "author": "John Stuart Mill", "genres": ["Social Sciences", "Non-Fiction"]},
    
    # Arts & Culture (1 book)
    {"id": 15264, "title": "The Decoration of Houses", "author": "Edith Wharton and Ogden Codman", "genres": ["Arts & Culture", "Non-Fiction"]}
]
...
def main():
    print("Seeding final Gutenberg categories to make sure each genre has exactly 5 books...")
    ...
    for idx, binfo in enumerate(final_books):
        bid = binfo["id"]
        title = binfo["title"]
        author = binfo["author"]
        genres = binfo["genres"]
        ...
        if not success:
            print(f"  Failed all attempts for {title}.")
            continue
        ...
        book_metadata = {
            ...
            "synopsis": f"A classic work of {genres[0]} by {author}, loaded from Project Gutenberg archives.",
    ...
    print("\nFinal Gutenberg categories seeding completed successfully!")
