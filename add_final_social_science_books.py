...
final_social_books = [
    {"id": 61, "title": "The Communist Manifesto", "author": "Karl Marx and Friedrich Engels", "genres": ["Social Sciences", "Non-Fiction"]},
    {"id": 71, "title": "Civil Disobedience", "author": "Henry David Thoreau", "genres": ["Social Sciences", "Non-Fiction"]}
]
...
def main():
    print("Downloading final social sciences fallback books...")
    ...
    for idx, binfo in enumerate(final_social_books):
        bid = binfo["id"]
        title = binfo["title"]
        author = binfo["author"]
        genres = binfo["genres"]
    ...
    print("\nSocial sciences fallback seeding completed successfully!")
